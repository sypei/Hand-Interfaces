...
namespace PDollarGestureRecognizer
{
    public class GestureIO
    {
        ...
        /// <returns></returns>
		public static SpellGesture ReadGestureFromXML(string xml) {

			XmlTextReader xmlReader = null;
			SpellGesture gesture = null;
		...
		/// <returns></returns>
		public static SpellGesture ReadGestureFromFile(string fileName) {
		...
		private static SpellGesture ReadGesture(XmlTextReader xmlReader)
        {
            ...
            return new SpellGesture(points.ToArray(), gestureName);
        }

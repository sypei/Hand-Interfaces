Shader "Hidden/GuineaLion/AnimatedBook/Simple Albedo" {
	Properties {
		...
		[KeywordEnum(None, BlackAndWhite, AlphaBlend, RGB_Independent)] _ImageMode ("Image Mode", Float) = 1
		
		_ColorR ("R Color", Color) = (0,0,0,1)
		_ColorG ("G Color", Color) = (0,0,0,1)
	...
	SubShader {
		...
		#pragma multi_compile _IMAGEMODE_NONE _IMAGEMODE_BLACKANDWHITE _IMAGEMODE_ALPHABLEND _IMAGEMODE_RGB_INDEPENDENT
		#pragma target 3.0

...
public class GestureRetrieval_Entertainment : MonoBehaviour
{
    ...
    private List<float> ss_wand =  new List<float>{1,1,1,1,1,//0-5
                                                    1,1,1,1,1,//6-10
                                                    1,1,1,1,1,//11-15
                                                    1,1,1,1,1,//16-20
                                                    1,1,1,1};//21-24
    private List<float> ss_mug =  new List<float>{1,1,1,1,1,//0-5
                                                    1,1,1,1,1,//6-10
                                                    1,1,1,1,1,//11-15
                                                    1,1,1,1,1,//16-20
                                                    1,1,1,1};//21-24
    private List<float> ss_book =  new List<float>{1,1,1,1,1,//0-5
                                                    1,1,1,1,1,//6-10
                                                    1,1,1,1,1,//11-15
                                                    1,1,1,1,1,//16-20
                                                    1,1,1,1};//21-24
    ...
    void Update()
    {
        ...
        if (thereAreBones)
        {
            ...
            if (writeLogger)
            {
                ModeLogger.text="Hand Interface - Entertainment";

    ...
    public sealed class SlicedHull {
        ...
        public GameObject CreateUpperHull(GameObject original, Material crossSectionMat) {
            ...
            if (newObject != null) {
                ...
                //     newObject.transform.localPosition.x,
                //     newObject.transform.localPosition.y+sliceDistance*newObject.transform.localScale.x,
                //     newObject.transform.localPosition.z);
                
                //newObject.layer = LayerMask.NameToLayer("Cuttable");
            }
        ...
        public GameObject CreateLowerHull(GameObject original, Material crossSectionMat) {
            ...
            if (newObject != null) {
                ...
                //     newObject.transform.localPosition.y-sliceDistance*newObject.transform.localScale.x,
                //     newObject.transform.localPosition.z);
                //newObject.transform.localPosition += sliceDistance*normalVector;
                //newObject.layer = LayerMask.NameToLayer("Cuttable");
            }

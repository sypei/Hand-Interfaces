...
public class RopeControllerSimple : MonoBehaviour 
{
    ...
    private float minRopeLength = 0.05f;
    ...
    void Start() 
	{
        springJoint = ropeEnd.GetComponent<SpringJoint>();
        ...
        ropeBase.GetComponent<Rigidbody>().mass = loadMass;
    }
    ...
    private void UpdateSpring()
    {
        ...
        springJoint.spring = kRope * 0.001f;
    ...
    private void DisplayRope()
    {
        ...
        Vector3 A = ropeEnd.position;
        Vector3 D = ropeBase.position;

        //Upper control point
        //To get a little curve at the top than at the bottom
        Vector3 B = A + ropeEnd.up * (-(A - D).magnitude * 0.1f);
        //B = A;

        //Lower control point
        Vector3 C = D + ropeBase.up * ((A - D).magnitude * 0.5f);
        ...
        //positions[0] = ropeEnd.position;
        //positions[1] = ropeBase.position;
